        ...
        <>
          <div className="flex items-start gap-8">
            <div className="flex-1 space-y-4">
              ...
              <div className="relative border-2 border-blood bg-smooth text-center justify-center rounded-md whitespace-nowrap">
                {transaction.image ? (
                  <img
                    className="mx-auto my-2 cursor-pointer w-[548px] h-[240px] object-cover rounded-lg active:h-full"
