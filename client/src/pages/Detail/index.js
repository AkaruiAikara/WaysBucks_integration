    ...
    <div className="lg:mx-20">
      <div className="flex flex-col md:flex-row gap-24">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 md:gap-x-10 gap-y-10 mt-5">
              <label className="relative">
                <input
                  className="absolute hidden checked:flex bottom-10 right-10 rounded-full text-blood w-6 h-6 transition-all focus:ring-blood"
                  type="checkbox"
                  name="toping1"
                  id="toping1"
                />
          ...
          <button className="text-center text-white bg-blood px-auto py-2.5 rounded-md hover:bg-red-600 focus:bg-red-900 focus:ring-4 focus:ring-red-200 mt-6">
            Add to Cart
          </button>
        </div>
      </div>
