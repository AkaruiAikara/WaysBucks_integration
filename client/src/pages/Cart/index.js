    ...
    <div className="mx-5 lg:mx-20">
      <div className="flex flex-col lg:flex-row gap-24 justify-center">
          ...
          <div className="flex items-center mt-5">
            ...
            <div className="flex flex-col ml-4 w-full space-y-2">
              ...
              <div className="flex flex-row justify-between items-center">
                <h5 className="text-lg text-maroon">
                  Toping :{" "}
                  <span className="text-blood">Bill Berry Boba, Manggo</span>
                </h5>
                <a href="#">
                  <img src={bin} alt="" />
                </a>
        ...
        <div className="text-center">
          ...
          <button className="text-center text-white bg-blood w-full py-2.5 mt-10 rounded-md hover:bg-red-600 focus:bg-red-900 focus:ring-4 focus:ring-red-200">
            Pay
          </button>
        </div>
      </div>
