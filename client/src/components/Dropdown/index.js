    ...
    return (
        <div className="absolute right-0 z-30 w-44 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700">
            <ul>
                ...
                <li>
                    <a onClick={() => dispatch({type: 'LOGOUT'})} className="cursor-pointer block py-4 px-4 text-md text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
