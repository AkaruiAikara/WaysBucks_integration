    ...
    return (
        <div className="mb-96 lg:mx-20 lg:mb-0">
            <div className="relative flex flex-column lg:flex-row items-center px-8 lg:pl-20 lg:pr-80 py-24 lg:py-20 lg:mr-48 bg-blood text-white rounded-lg">
                ...
                <img className="absolute right-0 md:right-48 top-0" src={slice} alt="slice" />
                <img className="absolute -bottom-8 -right-24" src={slice} alt="slice" />
                <img className="absolute rotate-90 -bottom-16 left-1/3" src={slice} alt="slice" />
                ...
                <img className="absolute w-3/4 -bottom-48 md:-bottom-1/2 right-0 left-0 mx-auto lg:bottom-auto lg:left-auto lg:-right-44 lg:w-1/2 rounded-lg" src={jumbotronimg} alt="jumbotron" />
            </div>
        </div>
    )
}